...
trait DecisionTreeBuilderAndBuilderBeingTested[Params, R, FullR, B <: Builder[Params, R, FullR, B, E], E <: EngineTools[Params, R]]
  extends BuilderTest[Params, R, FullR, B, E]
  with BuilderBeingTested[Params, R, FullR, B, E]
  with DecisionTreeBuilderForTests[Params, R] {
  import ReportableHelper._
  def s(seed: Seed, title: Option[String] = None, description: Option[String] = None, because: Option[Seed] = None,
    code: Option[CodeHolder[(Params)=>R]] = None, priority: Option[Int] = None, expected: Option[ResultSeed] = None,
    references: Set[Reference] = Set()) =
    new Scenario[Params, R](params(seed), title, description, because.collect { case seed: Seed => becauseCodeHolder(seed) },
...
trait BuilderBeingTested[Params, R, FullR, B <: Builder[Params, R, FullR, B, E], E <: EngineTools[Params, R]] {
  type Seed
  type ResultSeed
  ...
  def initializeBuilder(nodes: List[BuilderNode[Params, R]] = List(new EngineDescription[Params, R]))(implicit ldp: CddDisplayProcessor): B
  ...
  protected def scenarioObject(params: Params): Scenario[Params, R]
  protected def resultCodeHolder(seed: ResultSeed): CodeHolder[(Params)=>R]
  protected def becauseCodeHolder(seed: Seed) = CodeHolder[(Params)=>Boolean](becauseBfn(seed), s"because$seed")
  ...
  def defaultRoot: DecisionTreeNode[Params, R]
  ...
  def becauseBfn(seed: Seed): (Params)=>Boolean
}

trait BuilderTest[Params, R, FullR, B <: Builder[Params, R, FullR, B, E], E <: EngineTools[Params, R]]
  ...
  val buildEngine: BuildEngine[Params, R, FullR, E]
  def decisionTreeLens = buildEngine.decisionTreeLens
  def modifiedChildrenForBuild = buildEngine.builderWithModifyChildrenForBuild.modifyChildrenForBuild(currentBuilder.nodes.head.asInstanceOf[BuilderNodeAndHolder[Params, R]])
...
trait StringStringStringTest extends BuilderConcretizer[(String, String), String] {
  ...
  def becauseBfn(seed: String) = (p12: (String,String)) => contains(p12._1, seed) && contains(p12._2, seed)
}
trait StringStringStringStringTest extends BuilderConcretizer[(String, String, String), String] {
  ...
  def result(seed: String) = seed.toString
  def becauseBfn(seed: String) = (p123: (String,String,String)) => contains(p123._1, seed) && contains(p123._2, seed) && contains(p123._3, seed)
}
...
trait HolderHolderStringTest extends BuilderConcretizer[(Holder, Holder), String] {
  ...
  def result(seed: String) = seed.toString
  def becauseBfn(seed: String) = (p12: (Holder, Holder)) => contains(p12._1.value, seed) && contains(p12._2.value, seed)
}
...
trait HolderHolderHolderStringTest extends BuilderConcretizer[(Holder, Holder, Holder), String] {
  ...
  def result(seed: String) = seed.toString
  def becauseBfn(seed: String) = (p123: (Holder, Holder, Holder)) => contains(p123._1.value, seed) && contains(p123._2.value, seed) && contains(p123._3.value, seed)
}
trait Builder1Test[P, R, FullR]
  extends DecisionTreeBuilderAndBuilderBeingTested[P, R,  FullR, Builder1[P, R, FullR], Engine1[P, R, FullR]]
  ...
  protected def scenarioObject(p: P) = new Scenario[P, R](p)
...
trait SimpleBuilder1Test[P, R] extends Builder1Test[P, R, R] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[P,  R]] = BuildEngine.initialNodes)(implicit ldp: CddDisplayProcessor) =
...
trait FoldingBuilder1Test[P, R, FullR] extends Builder1Test[P, R, FullR] with FoldingBuilderTest[R, FullR] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[P,  R]] = BuildEngine.initialNodes(initialValue, foldingFn))(implicit ldp: CddDisplayProcessor) =
...
trait Builder2Test[P1, P2, R, FullR]
  extends DecisionTreeBuilderAndBuilderBeingTested[(P1, P2), R, FullR, Builder2[P1, P2, R, FullR], Engine2[P1, P2, R, FullR]]
  ...
  protected def resultCodeHolder(seed: ResultSeed) = new CodeHolder((p12) => result(seed), s"(p1,p2)=>result$seed")
  protected def scenarioObject(p: (P1, P2)) = new Scenario[(P1, P2), R](p)
  ...
  protected def becauseImpl(seed: Seed) = update(_.becauseHolder(becauseCodeHolder(seed)))
  protected def becauseExceptionImpl(e: Exception) = update(_.becauseHolder(CodeHolder((p12) => throw e, e.toString())))
...
trait SimpleBuilder2Test[P1, P2, R] extends Builder2Test[P1, P2, R, R] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[(P1, P2),  R]] = BuildEngine.initialNodes)(implicit ldp: CddDisplayProcessor) = Builder2[P1, P2, R, R](nodes, ExceptionMap(), buildEngine)(ldp)
...
trait FoldingBuilder2Test[P1, P2, R, FullR] extends Builder2Test[P1, P2, R, FullR] with FoldingBuilderTest[R, FullR] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[(P1, P2), R]] = BuildEngine.initialNodes(initialValue, foldingFn))(implicit ldp: CddDisplayProcessor) =
...
trait Builder3Test[P1, P2, P3, R, FullR]
  extends DecisionTreeBuilderAndBuilderBeingTested[(P1, P2, P3),  R, FullR, Builder3[P1, P2, P3, R, FullR], Engine3[P1, P2, P3, R, FullR]]
  ...
  protected def resultCodeHolder(seed: ResultSeed) = new CodeHolder((p123) => result(seed), s"(p1: P1, p2: P2, p3: P3) => Builder3Test.this.result($seed)")
  protected def scenarioObject(p: (P1, P2, P3)) = new Scenario[(P1, P2, P3),  R ](p)
  ...
  protected def becauseExceptionImpl(e: Exception) = update(_.becauseHolder(CodeHolder((p123) => throw e, e.toString())))
...
trait SimpleBuilder3Test[P1, P2, P3, R] extends Builder3Test[P1, P2, P3, R, R] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[(P1, P2, P3),  R]] = BuildEngine.initialNodes)(implicit ldp: CddDisplayProcessor) =
...
trait FoldingBuilder3Test[P1, P2, P3, R, FullR] extends Builder3Test[P1, P2, P3, R, FullR] with FoldingBuilderTest[R, FullR] {
  ...
  def initializeBuilder(nodes: List[BuilderNode[(P1, P2, P3),  R]] = BuildEngine.initialNodes(initialValue, foldingFn))(implicit ldp: CddDisplayProcessor) =
