...
trait ABuilderFactory1[P, R] extends EngineUniverse[R] with Engine1Types[P, R] {
  ...
  trait ABuilder1 extends ScenarioBuilder {
    ...
    def build = new Engine(description, optCode) with Function[P, R] {
...
class BuilderFactory1[P, R](override val logger: TddLogger = TddLogger.noLogger) extends ABuilderFactory1[P, R] {
  ...
  class Builder1(val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None) extends ABuilder1 {
    def thisAsBuilder = this
    def withCases(description: Option[String], useCases: List[UseCase], optCode: Option[Code]) =
      new Builder1(description, useCases, optCode)
  }
}
...
trait ABuilderFactory2[P1, P2, R] extends EngineUniverse[R] with Engine2Types[P1, P2, R] {
  ...
  trait ABuilder2 extends ScenarioBuilder {
    ...
    def build = new Engine(description, optCode) with Function2[P1, P2, R] {
      def useCases = useCasesForBuild
...
class BuilderFactory2[P1, P2, R](override val logger: TddLogger = TddLogger.noLogger) extends ABuilderFactory2[P1, P2, R] {
  ...
  class Builder2(val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None) extends ABuilder2 {
    def thisAsBuilder = this
    def withCases(description: Option[String], useCases: List[UseCase], optCode: Option[Code]) = new Builder2(description, useCases, optCode)
  }
}
...
class BuilderFactory3[P1, P2, P3, R](override val logger: TddLogger = TddLogger.noLogger) extends EngineUniverse[R] with Engine3Types[P1, P2, P3, R] {
  ...
  class Builder3(val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None) extends ScenarioBuilder {
    def thisAsBuilder = this
    def withCases(engineDescription: Option[String], useCases: List[UseCase], optCode: Option[Code]) = new Builder3(engineDescription, useCases, optCode)
