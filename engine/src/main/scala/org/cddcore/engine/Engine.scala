...
class BuilderFactory1[P, R](override val logger: TddLogger = TddLogger.noLogger) extends ABuilderFactory1[P, R] {
  ...
  class Builder1(val title: Option[String] = None, val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None, val expected: Option[ROrException[R]] = None, val priority: Int=0, val references: List[Reference]=List()) extends ABuilder1 {
    def thisAsBuilder = this
    def withCases(title: Option[String], description: Option[String], useCases: List[UseCase], optCode: Option[Code], expected: Option[ROrException[R]], priority: Int, references: List[Reference]) =
      new Builder1(title, description, useCases, optCode, expected, priority, references)
  }
}
...
trait ABuilderFactory2[P1, P2, R] extends EngineUniverse[R] with Engine2Types[P1, P2, R] {
  ...
  trait ABuilder2 extends ScenarioBuilder {
    ...
    def build =  new Engine(title, description, optCode, priority, references) with Function2[P1, P2, R] {
      def useCases = useCasesForBuild
...
class BuilderFactory2[P1, P2, R](override val logger: TddLogger = TddLogger.noLogger) extends ABuilderFactory2[P1, P2, R] {
  ...
  class Builder2(val title: Option[String] = None, val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None, val expected: Option[ROrException[R]] = None, val priority: Int=0, val references: List[Reference]=List()) extends ABuilder2 {
    def thisAsBuilder = this
    def withCases(title: Option[String], description: Option[String], useCases: List[UseCase], optCode: Option[Code], expected: Option[ROrException[R]], priority: Int, references: List[Reference]=List()) = 
      new Builder2(title,description, useCases, optCode, expected, priority, references)
  }
}
...
class BuilderFactory3[P1, P2, P3, R](override val logger: TddLogger = TddLogger.noLogger) extends EngineUniverse[R] with Engine3Types[P1, P2, P3, R] {
  ...
  class Builder3(val title: Option[String]= None, val description: Option[String] = None, val useCases: List[UseCase] = List(), val optCode: Option[Code] = None, val expected: Option[ROrException[R]] = None, val priority: Int=0, val references: List[Reference]=List()) extends ScenarioBuilder {
    def thisAsBuilder = this
    def withCases(title: Option[String], description: Option[String], useCases: List[UseCase], optCode: Option[Code], expected: Option[ROrException[R]], priority: Int, references: List[Reference]) = 
      new Builder3(title, description, useCases, optCode, expected, priority, references)
    def scenario(p1: P1, p2: P2, p3: P3, description: String = null) = newScenario(description, List(p1, p2, p3))
    def build =  new Engine(title, description, optCode, priority, references) with Function3[P1, P2, P3, R] {
      def useCases = useCasesForBuild
